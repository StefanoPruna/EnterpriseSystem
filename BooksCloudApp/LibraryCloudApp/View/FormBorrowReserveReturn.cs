...
using Controller;
//using Controller.ServiceReferenceBooks;
...
namespace View
{
    public partial class FormBorrowReserveReturn : Form
    {
        ...
        private void borrowButton_Click(object sender, EventArgs e)
        {
            ...
            //The date in the "Borrow the Book Today" field cannot be changed
            //It assumes that you can only borrow a book today/now, otherwise,
            //User can reserve it and select a different date
            //User can only borrow the book if the "Return Date" field is different than today
            if (userName == "" || bookId == "")
            {
        ...
        {
            //This Function Button works in the same way as the Borrow one, so it's unnecessary
            System.DateTime currentTime = borrowDateTimePicker.Value;
            if (returnDateTimePicker.Value > currentTime)
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //It only works if both the UID and the Book ISBN fields have data
        ...
        private void bookNameComboBox_SelectedIndexChanged_1(object sender, EventArgs e)
        {
