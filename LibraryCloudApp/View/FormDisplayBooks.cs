...
namespace View
{
    public partial class FormDisplayBooks : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            //It works only if the User inserts data in the fields, otherwise an error message pops up
            if (searchBookName == "" || publishedYear == "")
            {
                if (MessageBox.Show("Please insert a value in all of the three fields: bookname, publisher && publish year", "Retry", MessageBoxButtons.RetryCancel, MessageBoxIcon.Error) == DialogResult.Retry)
                {
