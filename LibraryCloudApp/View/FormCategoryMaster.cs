...
namespace View
{
    public partial class FormCategoryMaster : Form
    {
        ...
        private void updateButton_Click(object sender, EventArgs e)
        {
            ...
            //It'll update if all fields have data and in the:
            //"Insert The Category name to be Changed" has the current name;
            //"Insert the CID..." has the current CID;
            //"Category name to be updated..." the new name that you want to change
        ...
        private void deleteButton_Click(object sender, EventArgs e)
        {
            ...
            //To work,both the "Insert the CID..." and the "Category name to be updated..." fields
